...
var methodsToProvide = {
    back: [],
    echo: ['message', 'style'],
    each: ['items', function callback() {}],
    eachThen: ['items', function then() {}],
    forward: [],
    ...
    thenByPass: ['number'],
    thenByPassIf: [function condition() {}, 'number'],
    thenByPassUnless: [function condition () {}, 'number'],
    userAgent: ['agent'],
    ...
    waitForAlert: [
        function then() {}, function onTimeout() {}, 'timeout'        
    ],
    waitForExec: [
        'command', 'parameters', function then() {}, function onTimeout() {}, 'timeout'
    ],
    waitForPopup: [
    ...
    waitForUrl: [
        'url', function then() {}, function onTimeout() {}, 'timeout'
    ],
    waitForText: [
        'text', function then() {}, function onTimeout() {}, 'timeout'
    ],
    waitForSelectorTextChange: [
        'selector', function then() {}, function onTimeout() {}, 'timeout'
    ],
    waitUntilVisible: [
        'selector', function then () {},
        function onTimeout () {}, 'timeout'
    ...
    warn: ['message'],
    withSelectorScope: ['selector', function then() {}],
